...
(function () {
    if (window.CKEDITOR && window.CKEDITOR.dom) return; window.CKEDITOR || (window.CKEDITOR = function () {
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i, d = {
            timestamp: "G4CD", version: "4.5.9", revision: "a35abfe", rnd: Math.floor(900 * Math.random()) + 100, _: { pending: [], basePathSrcPattern: a }, status: "unloaded", basePath: function () {
    ...
    CKEDITOR.event || (CKEDITOR.event = function () { }, CKEDITOR.event.implementOn = function (a) { var d = CKEDITOR.event.prototype, b; for (b in d) null == a[b] && (a[b] = d[b]) }, CKEDITOR.event.prototype = function () {
        ...
        return {
            ...
            once: function () { var a = Array.prototype.slice.call(arguments), b = a[1]; a[1] = function (a) { a.removeListener(); return b.apply(this, arguments) }; return this.on.apply(this, a) }, capture: function () { CKEDITOR.event.useCapture = 1; var a = this.on.apply(this, arguments); CKEDITOR.event.useCapture = 0; return a }, fire: function () {
                var a = 0, b = function () { a = 1 }, g = 0, l = function () { g = 1 }; return function (k, q, w) {
                    var f = d(this)[k]; k = a; var y = g; a = g = 0; if (f) {
                        var A = f.listeners; if (A.length) for (var A = A.slice(0), t, D = 0; D < A.length; D++) {
                            if (f.errorProof) try {
                                t =
                                A[D].call(this, w, q, b, l)
                            } catch (p) { } else t = A[D].call(this, w, q, b, l); !1 === t ? g = 1 : "undefined" != typeof t && (q = t); if (a || g) break
                        }
                    } q = g ? !1 : "undefined" == typeof q ? !0 : q; a = k; g = y; return q
                }
    ...
    (function () {
        var a = [], d = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "", b = /&/g, c = />/g, e = /</g, g = /"/g, l = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g, k = { lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­" }, q = function (a, f) { return "#" == f[0] ? String.fromCharCode(parseInt(f.slice(1), 10)) : k[f] }; CKEDITOR.on("reset", function () { a = [] }); CKEDITOR.tools = {
            ...
            }, extend: function (a) { var f = arguments.length, b, c; "boolean" == typeof (b = arguments[f - 1]) ? f-- : "boolean" == typeof (b = arguments[f - 2]) && (c = arguments[f - 1], f -= 2); for (var k = 1; k < f; k++) { var d = arguments[k], p; for (p in d) if (!0 === b || null == a[p]) if (!c || p in c) a[p] = d[p] } return a }, prototypedCopy: function (a) { var f = function () { }; f.prototype = a; return new f }, copy: function (a) { var f = {}, b; for (b in a) f[b] = a[b]; return f }, isArray: function (a) { return "[object Array]" == Object.prototype.toString.call(a) },
            ...
            }, htmlEncode: function (a) { return void 0 === a || null === a ? "" : String(a).replace(b, "\x26amp;").replace(c, "\x26gt;").replace(e, "\x26lt;") }, htmlDecode: function (a) { return a.replace(l, q) }, htmlEncodeAttr: function (a) { return CKEDITOR.tools.htmlEncode(a).replace(g, "\x26quot;") }, htmlDecodeAttr: function (a) { return CKEDITOR.tools.htmlDecode(a) },
            ...
            g = /[\n\t\r]/g; CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
                ...
                is: function () { var a = this.getName(); if ("object" == typeof arguments[0]) return !!arguments[0][a]; for (var b = 0; b < arguments.length; b++)if (arguments[b] == a) return !0; return !1 }, isEditable: function (a) {
                    ...
                    var b = 0, c = 0, f = this.getDocument(), d = f.getBody(), e = "BackCompat" == f.$.compatMode; if (document.documentElement.getBoundingClientRect) {
                        var t =
                            this.$.getBoundingClientRect(), g = f.$.documentElement, p = g.clientTop || d.$.clientTop || 0, x = g.clientLeft || d.$.clientLeft || 0, l = !0; CKEDITOR.env.ie && (l = f.getDocumentElement().contains(this), f = f.getBody().contains(this), l = e && f || !e && l); l && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = d.$.scrollLeft || g.scrollLeft, c = d.$.scrollTop || g.scrollTop) : (c = e ? d.$ : g, b = c.scrollLeft, c = c.scrollTop), b = t.left + b - x, c = t.top + c - p)
                    } else for (p = this, x = null; p && "body" != p.getName() && "html" != p.getName();) {
                        b += p.$.offsetLeft -
                        p.$.scrollLeft; c += p.$.offsetTop - p.$.scrollTop; p.equals(this) || (b += p.$.clientLeft || 0, c += p.$.clientTop || 0); for (; x && !x.equals(p);)b -= x.$.scrollLeft, c -= x.$.scrollTop, x = x.getParent(); x = p; p = (t = p.$.offsetParent) ? new CKEDITOR.dom.element(t) : null
                    } a && (t = this.getWindow(), p = a.getWindow(), !t.equals(p) && t.$.frameElement && (a = (new CKEDITOR.dom.element(t.$.frameElement)).getDocumentPosition(a), b += a.x, c += a.y)); document.documentElement.getBoundingClientRect || !CKEDITOR.env.gecko || e || (b += this.$.clientLeft ? 1 : 0, c += this.$.clientTop ?
                        1 : 0); return { x: b, y: c }
                    ...
                    var f, d, e, t; function g(b, c) {
                        ...
                        p(a, e), r = this.$.offsetHeight; f = this.$.offsetWidth; var h = a.$.clientHeight, n = a.$.clientWidth; e = d.x - x(this, "left") - u.x || 0; t = d.y - x(this, "top") - u.y || 0; f = d.x + f + x(this, "right") - (u.x + n) || 0; d = d.y + r + x(this, "bottom") - (u.y + h) || 0; (0 > t || 0 < d) && g(0, !0 === b ? t : !1 === b ? d : 0 > t ? t : d); c && (0 > e || 0 < f) && g(0 > e ? e : f, 0)
                }, setState: function (a, b, c) {
                    b = b || "cke"; switch (a) {
                        case CKEDITOR.TRISTATE_ON: this.addClass(b + "_on"); this.removeClass(b + "_off"); this.removeClass(b + "_disabled"); c && this.setAttribute("aria-pressed", !0); c && this.removeAttribute("aria-disabled");
                ...
                copyAttributes: function (a, b) { var c = this.$.attributes; b = b || {}; for (var f = 0; f < c.length; f++) { var d = c[f], e = d.nodeName.toLowerCase(), t; if (!(e in b)) if ("checked" == e && (t = this.getAttribute(e))) a.setAttribute(e, t); else if (!CKEDITOR.env.ie || this.hasAttribute(e)) t = this.getAttribute(e), null === t && (t = d.nodeValue), a.setAttribute(e, t) } "" !== this.$.style.cssText && (a.$.style.cssText = this.$.style.cssText) }, renameNode: function (a) {
                    if (this.getName() != a) {
                        ...
                        this.moveChildren(a); this.getParent(!0) && this.$.parentNode.replaceChild(a.$, this.$); a.$["data-cke-expando"] = this.$["data-cke-expando"]; this.$ = a.$; delete this.getName
                    }
                    ...
                    a = "data-" + a; if (void 0 === b) return this.getAttribute(a); !1 === b ? this.removeAttribute(a) : this.setAttribute(a,
                        b); return null
                ...
                var d = Math.max(this.$["offset" +
                    CKEDITOR.tools.capitalize(a)], this.$["client" + CKEDITOR.tools.capitalize(a)]) || 0; b && (d -= c.call(this, a)); return d
            }
    ...
    (function () {
        function a(a, b) {
            var c = this.range; if (this._.end) return null; if (!this._.start) { this._.start = 1; if (c.collapsed) return this.end(), null; c.optimize() } var f, d = c.startContainer; f = c.endContainer; var e = c.startOffset, y = c.endOffset, r, h = this.guard, n = this.type, m = a ? "getPreviousSourceNode" : "getNextSourceNode"; if (!a && !this._.guardLTR) {
                var z = f.type == CKEDITOR.NODE_ELEMENT ? f : f.getParent(), B = f.type == CKEDITOR.NODE_ELEMENT ? f.getChild(y) : f.getNext(); this._.guardLTR = function (a, b) {
        ...
        CKEDITOR.dom.walker.bookmark = function (a, b) { function c(a) { return a && a.getName && "span" == a.getName() && a.data("cke-bookmark") } return function (f) { var d, e; d = f && f.type != CKEDITOR.NODE_ELEMENT && (e = f.getParent()) && c(e); d = a ? d : d || c(f); return !!(b ^ d) } }; CKEDITOR.dom.walker.whitespaces = function (a) { return function (b) { var c; b && b.type == CKEDITOR.NODE_TEXT && (c = !CKEDITOR.tools.trim(b.getText()) || CKEDITOR.env.webkit && b.getText() == CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE); return !!(a ^ c) } }; CKEDITOR.dom.walker.invisible =
            function (a) { var b = CKEDITOR.dom.walker.whitespaces(), c = CKEDITOR.env.webkit ? 1 : 0; return function (f) { b(f) ? f = 1 : (f.type == CKEDITOR.NODE_TEXT && (f = f.getParent()), f = f.$.offsetWidth <= c); return !!(a ^ f) } }; CKEDITOR.dom.walker.nodeType = function (a, b) { return function (c) { return !!(b ^ c.type == a) } }; CKEDITOR.dom.walker.bogus = function (a) {
                ...
                function (a) { return function (b) { b = g(b) || l(b) || k(b); return !!(a ^ b) } }; var w = CKEDITOR.dom.walker.ignored(); CKEDITOR.dom.walker.empty = function (a) { return function (b) { for (var c = 0, f = b.getChildCount(); c < f; ++c)if (!w(b.getChild(c))) return !!a; return !a } }; var f = CKEDITOR.dom.walker.empty(), y = CKEDITOR.dom.walker.validEmptyBlockContainers = CKEDITOR.tools.extend(function (a) { var b = {}, c; for (c in a) CKEDITOR.dtd[c]["#"] && (b[c] = 1); return b }(CKEDITOR.dtd.$block), { caption: 1, td: 1, th: 1 }); CKEDITOR.dom.walker.editable = function (a) {
                    return function (b) {
                        b =
                        w(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(y) && f(b)) ? !0 : !1; return !!(a ^ b)
                    }
    ...
    (function () {
        function a(a) { a.collapsed = a.startContainer && a.endContainer && a.startContainer.equals(a.endContainer) && a.startOffset == a.endOffset } function d(a, b, c, d, e) {
            function p(a, b, c, f) { var d = c ? a.getPrevious() : a.getNext(); if (f && k) return d; h || f ? b.append(a.clone(!0, e), c) : (a.remove(), r && b.append(a)); return d } function g() { var a, b, c, f = Math.min(v.length, I.length); for (a = 0; a < f; a++)if (b = v[a], c = I[a], !b.equals(c)) return a; return a - 1 } function l() {
                var b = J - 1, c = H && w && !n.equals(m); b < F - 1 || b < L - 1 || c ? (c ? a.moveToPosition(m,
            ...
            } a.optimizeBookmark(); var k = 0 === b, r = 1 == b, h = 2 == b; b = h || r; var n = a.startContainer, m = a.endContainer,
                z = a.startOffset, B = a.endOffset, E, C, H, w, q, Q; if (h && m.type == CKEDITOR.NODE_TEXT && n.equals(m)) n = a.document.createText(n.substring(z, B)), c.append(n); else {
                m.type == CKEDITOR.NODE_TEXT ? h ? Q = !0 : m = m.split(B) : 0 < m.getChildCount() ? B >= m.getChildCount() ? (m = m.getChild(B - 1), C = !0) : m = m.getChild(B) : w = C = !0; n.type == CKEDITOR.NODE_TEXT ? h ? q = !0 : n.split(z) : 0 < n.getChildCount() ? 0 === z ? (n = n.getChild(z), E = !0) : n = n.getChild(z - 1) : H = E = !0; for (var v = n.getParents(), I = m.getParents(), J = g(), F = v.length - 1, L = I.length - 1, K = c, ba, Z, V, fa = -1, N = J; N <= F; N++) {
                    Z =
                    v[N]; V = Z.getNext(); for (N != F || Z.equals(I[N]) && F < L ? b && (ba = K.append(Z.clone(0, e))) : E ? p(Z, K, !1, H) : q && K.append(a.document.createText(Z.substring(z))); V;) { if (V.equals(I[N])) { fa = N; break } V = p(V, K) } K = ba
                } K = c; for (N = J; N <= L; N++)if (c = I[N], V = c.getPrevious(), c.equals(v[N])) b && (K = K.getChild(0)); else { N != L || c.equals(v[N]) && L < F ? b && (ba = K.append(c.clone(0, e))) : C ? p(c, K, !1, w) : Q && K.append(a.document.createText(c.substring(0, B))); if (N > fa) for (; V;)V = p(V, K, !0); K = ba } h || l()
                }
        } function b() {
                ...
                function c(a) { return a && a.type == CKEDITOR.NODE_ELEMENT && a.hasAttribute("contenteditable") ? null : a } var d = new RegExp(/[^\s\ufeff]/); switch (a) {
                    case CKEDITOR.ENLARGE_INLINE: var e = 1; case CKEDITOR.ENLARGE_ELEMENT: var p = function (a, b) {
                        var c = new CKEDITOR.dom.range(l); c.setStart(a, b); c.setEndAt(l, CKEDITOR.POSITION_BEFORE_END); var c = new CKEDITOR.dom.walker(c), f; for (c.guard = function (a) { return !(a.type == CKEDITOR.NODE_ELEMENT && a.isBlockBoundary()) }; f =
                            c.next();) { if (f.type != CKEDITOR.NODE_TEXT) return !1; E = f != a ? f.getText() : f.substring(b); if (d.test(E)) return !1 } return !0
                    }; if (this.collapsed) break; var g = this.getCommonAncestor(), l = this.root, k, r, h, n, m, z = !1, B, E; B = this.startContainer; var C = this.startOffset; B.type == CKEDITOR.NODE_TEXT ? (C && (B = !CKEDITOR.tools.trim(B.substring(0, C)).length && B, z = !!B), B && ((n = B.getPrevious()) || (h = B.getParent()))) : (C && (n = B.getChild(C - 1) || B.getLast()), n || (h = B)); for (h = c(h); h || n;) {
                        if (h && !n) {
                        !m && h.equals(g) && (m = !0); if (e ? h.isBlockBoundary() :
                            !l.contains(h)) break; z && "inline" == h.getComputedStyle("display") || (z = !1, m ? k = h : this.setStartBefore(h)); n = h.getPrevious()
                            ...
                            if (n.type == CKEDITOR.NODE_TEXT) E = n.getText(), d.test(E) && (n = null), B = /[\s\ufeff]$/.test(E); else if ((n.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && n.is("br")) && !n.data("cke-bookmark")) if (z && CKEDITOR.dtd.$removeEmpty[n.getName()]) {
                                E = n.getText(); if (d.test(E)) n = null; else for (var C = n.$.getElementsByTagName("*"), H = 0, w; w =
                                    C[H++];)if (!CKEDITOR.dtd.$removeEmpty[w.nodeName.toLowerCase()]) { n = null; break } n && (B = !!E.length)
                            } else n = null; B && (z ? m ? k = h : h && this.setStartBefore(h) : z = !0); if (n) { B = n.getPrevious(); if (!h && !B) { h = n; n = null; break } n = B } else h = null
                        } h && (h = c(h.getParent()))
                    } B = this.endContainer; C = this.endOffset; h = n = null; m = z = !1; B.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(B.substring(C)).length ? z = !0 : (z = !B.getLength(), C == B.getLength() ? (n = B.getNext()) || (h = B.getParent()) : p(B, C) && (h = B.getParent())) : (n = B.getChild(C)) || (h = B); for (; h ||
                        n;) {
                            if (h && !n) { !m && h.equals(g) && (m = !0); if (e ? h.isBlockBoundary() : !l.contains(h)) break; z && "inline" == h.getComputedStyle("display") || (z = !1, m ? r = h : h && this.setEndAfter(h)); n = h.getNext() } for (; n;) {
                                B = !1; if (n.type == CKEDITOR.NODE_TEXT) E = n.getText(), p(n, 0) || (n = null), B = /^[\s\ufeff]/.test(E); else if (n.type == CKEDITOR.NODE_ELEMENT) {
                                    if ((0 < n.$.offsetWidth || b && n.is("br")) && !n.data("cke-bookmark")) if (z && CKEDITOR.dtd.$removeEmpty[n.getName()]) {
                                        E = n.getText(); if (d.test(E)) n = null; else for (C = n.$.getElementsByTagName("*"), H =
                                            0; w = C[H++];)if (!CKEDITOR.dtd.$removeEmpty[w.nodeName.toLowerCase()]) { n = null; break } n && (B = !!E.length)
                                    } else n = null
                                } else B = 1; B && z && (m ? r = h : this.setEndAfter(h)); if (n) { B = n.getNext(); if (!h && !B) { h = n; n = null; break } n = B } else h = null
                            } h && (h = c(h.getParent()))
                        } k && r && (g = k.contains(r) ? r : k, this.setStartBefore(g), this.setEndAfter(g)); break; case CKEDITOR.ENLARGE_BLOCK_CONTENTS: case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS: h = new CKEDITOR.dom.range(this.root); l = this.root; h.setStartAt(l, CKEDITOR.POSITION_AFTER_START); h.setEnd(this.startContainer,
                        ...
                        q = q || l; this.setEndAt(q, !h && this.checkEndOfBlock() || h && q.contains(h) ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_BEFORE_START); Q && this.setEndAfter(Q)
                }
            }, shrink: function (a, b, c) {
                if (!this.collapsed) {
                    a = a || CKEDITOR.SHRINK_TEXT; var d = this.clone(), e = this.startContainer, p = this.endContainer, g = this.startOffset, l = this.endOffset, k = 1, r = 1; e && e.type == CKEDITOR.NODE_TEXT && (g ? g >= e.getLength() ? d.setStartAfter(e) : (d.setStartBefore(e), k = 0) : d.setStartBefore(e)); p && p.type == CKEDITOR.NODE_TEXT && (l ? l >= p.getLength() ? d.setEndAfter(p) :
                        (d.setEndAfter(p), r = 0) : d.setEndBefore(p)); var d = new CKEDITOR.dom.walker(d), h = CKEDITOR.dom.walker.bookmark(); d.evaluator = function (b) { return b.type == (a == CKEDITOR.SHRINK_ELEMENT ? CKEDITOR.NODE_ELEMENT : CKEDITOR.NODE_TEXT) }; var n; d.guard = function (b, d) {
                            if (h(b)) return !0; if (a == CKEDITOR.SHRINK_ELEMENT && b.type == CKEDITOR.NODE_TEXT || d && b.equals(n) || !1 === c && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary() || b.type == CKEDITOR.NODE_ELEMENT && b.hasAttribute("contenteditable")) return !1; d || b.type != CKEDITOR.NODE_ELEMENT ||
                                (n = b); return !0
            ...
            b.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$empty[b.getName()] && (c = b.getIndex(), b = b.getParent()); this._setStartContainer(b); this.startOffset =
                ...
                if (a.type == CKEDITOR.NODE_ELEMENT && !a.isEditable(!1)) return this.moveToPosition(a, b ? CKEDITOR.POSITION_AFTER_END : CKEDITOR.POSITION_BEFORE_START), !0; for (var c = 0; a;) {
                    ...
                    b && this.endContainer && this.checkEndOfBlock() && k.test(a.getText()) ? this.moveToPosition(a,
                        ...
                        !0; var d = a, e = c, p = void 0; d.type == CKEDITOR.NODE_ELEMENT && d.isEditable(!1) && (p = d[b ? "getLast" : "getFirst"](w)); e || p || (p = d[b ? "getPrevious" : "getNext"](w)); a = p
                } return !!c
    ...
    (function () {
        function a(a) { 1 > arguments.length || (this.range = a, this.forceBrBreak = 0, this.enlargeBr = 1, this.enforceRealBlocks = 0, this._ || (this._ = {})) } function d(a) { var b = []; a.forEach(function (a) { if ("true" == a.getAttribute("contenteditable")) return b.push(a), !1 }, CKEDITOR.NODE_ELEMENT, !0); return b } function b(a, c, e, g) {
            ...
            k = function (a) { return g(a) && l(a) }, q = { dd: 1, dt: 1, li: 1 }; a.prototype = {
                getNextParagraph: function (a) {
                    var d, l, A, t, D; a = a || "p"; if (this._.nestedEditable) {
                        ...
                        var p = this.range.clone(); l = p.startPath(); var x = p.endPath(), G = !p.collapsed && c(p, l.block), u = !p.collapsed && c(p, x.block, 1); p.shrink(CKEDITOR.SHRINK_ELEMENT, !0); G && p.setStartAt(l.block, CKEDITOR.POSITION_BEFORE_END); u && p.setEndAt(x.block, CKEDITOR.POSITION_AFTER_START); l = p.endContainer.hasAscendant("pre", !0) || p.startContainer.hasAscendant("pre", !0); p.enlarge(this.forceBrBreak && !l || !this.enlargeBr ? CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS : CKEDITOR.ENLARGE_BLOCK_CONTENTS);
                        p.collapsed || (l = new CKEDITOR.dom.walker(p.clone()), x = CKEDITOR.dom.walker.bookmark(!0, !0), l.evaluator = x, this._.nextNode = l.next(), l = new CKEDITOR.dom.walker(p.clone()), l.evaluator = x, l = l.previous(), this._.lastNode = l.getNextSourceNode(!0, null, p.root), this._.lastNode && this._.lastNode.type == CKEDITOR.NODE_TEXT && !CKEDITOR.tools.trim(this._.lastNode.getText()) && this._.lastNode.getParent().isBlockBoundary() && (x = this.range.clone(), x.moveToPosition(this._.lastNode, CKEDITOR.POSITION_AFTER_END), x.checkEndOfBlock() &&
                            (x = new CKEDITOR.dom.elementPath(x.endContainer, x.root), this._.lastNode = (x.block || x.blockLimit).getNextSourceNode(!0))), this._.lastNode && p.root.contains(this._.lastNode) || (this._.lastNode = this._.docEndMarker = p.document.createText(""), this._.lastNode.insertAfter(l)), p = null); this._.started = 1; l = p
                    } x = this._.nextNode; p = this._.lastNode; for (this._.nextNode = null; x;) {
                        var G = 0, u = x.hasAscendant("pre"), r = x.type != CKEDITOR.NODE_ELEMENT, h = 0; if (r) x.type == CKEDITOR.NODE_TEXT && e.test(x.getText()) && (r = 0); else {
                            var n = x.getName();
                        ...
                        A = (!G || r) && x.equals(p); if (l && !G) for (; !x.getNext(k) && !A;) { n = x.getParent(); if (n.isBlockBoundary(this.forceBrBreak && !u && { br: 1 })) { G = 1; r = 0; A || n.equals(p); l.setEndAt(n, CKEDITOR.POSITION_BEFORE_END); break } x = n; r = 1; A = x.equals(p); h = 1 } r && l.setEndAt(x, CKEDITOR.POSITION_AFTER_END); x = this._getNextSourceNode(x, h, p); if ((A = !x) || G && l) break
                    } if (!d) {
                        if (!l) return this._.docEndMarker && this._.docEndMarker.remove(), this._.nextNode = null; d = new CKEDITOR.dom.elementPath(l.startContainer, l.root); x = d.blockLimit; G = { div: 1, th: 1, td: 1 };
    ...
    (function () {
        function a(a, b, c, d, e) {
            var h, n; a = []; for (h in b) {
                n = b[h]; n = "boolean" == typeof n ? {} : "function" == typeof n ? { match: n } : H(n); "$" != h.charAt(0) && (n.elements = h); c && (n.featureName = c.toLowerCase()); var m = n; m.elements = l(m.elements, /\s+/) || null; m.propertiesOnly = m.propertiesOnly || !0 === m.elements; var f = /\s*,\s*/, p = void 0; for (p in Q) {
                m[p] = l(m[p], f) || null; var F = m, r = v[p], g = l(m[v[p]], f), z = m[p], E = [], B = !0, L = void 0; g ? B = !1 : g = {}; for (L in z) "!" == L.charAt(0) && (L = L.slice(1), E.push(L), g[L] = !0, B = !1); for (; L = E.pop();)z[L] =
                    z["!" + L], delete z["!" + L]; F[r] = (B ? !1 : g) || null
                } m.match = m.match || null; d.push(n); a.push(n)
            } b = e.elements; e = e.generic; var k; c = 0; for (d = a.length; c < d; ++c) {
                h = H(a[c]); n = !0 === h.classes || !0 === h.styles || !0 === h.attributes; m = h; p = r = f = void 0; for (f in Q) m[f] = G(m[f]); F = !0; for (p in v) { f = v[p]; r = m[f]; g = []; z = void 0; for (z in r) -1 < z.indexOf("*") ? g.push(new RegExp("^" + z.replace(/\*/g, ".*") + "$")) : g.push(z); r = g; r.length && (m[f] = r, F = !1) } m.nothingRequired = F; m.noProperties = !(m.attributes || m.classes || m.styles); if (!0 === h.elements ||
            ...
            b) { if (!a) return !1; var c = !1, d = !0 === a, h; for (h in b) if (d || a(h)) delete b[h], c = !0; return c } function g(a, b, c) { if (a.disabled || a.customConfig && !c || !b) return !1; a._.cachedChecks = {}; return !0 } function l(a, b) { if (!a) return !1; if (!0 === a) return a; if ("string" == typeof a) return a = R(a), "*" == a ? !0 : CKEDITOR.tools.convertArrayToObject(a.split(b)); if (CKEDITOR.tools.isArray(a)) return a.length ? CKEDITOR.tools.convertArrayToObject(a) : !1; var c = {}, d = 0, h; for (h in a) c[h] = a[h], d++; return d ? c : !1 } function k(a, b) {
                ...
                var c, d, h, n; if (h = a.requiredClasses) for (n = b.classes, c = 0; c < h.length; ++c)if (d = h[c], "string" == typeof d) { if (-1 == CKEDITOR.tools.indexOf(n, d)) return !1 } else if (!CKEDITOR.tools.checkIfAnyArrayItemMatches(n, d)) return !1; return q(b.styles, a.requiredStyles) && q(b.attributes, a.requiredAttributes)
            } function q(a, b) { if (!b) return !0; for (var c = 0, d; c < b.length; ++c)if (d = b[c], "string" == typeof d) { if (!(d in a)) return !1 } else if (!CKEDITOR.tools.checkIfAnyObjectPropertyMatches(a, d)) return !1; return !0 } function w(a) {
                if (!a) return {};
                a = a.split(/\s*,\s*/).sort(); for (var b = {}; a.length;)b[a.shift()] = "cke-test"; return b
            } function f(a) { var b, c, d, h, n = {}, e = 1; for (a = R(a); b = a.match(I);)(c = b[2]) ? (d = y(c, "styles"), h = y(c, "attrs"), c = y(c, "classes")) : d = h = c = null, n["$" + e++] = { elements: b[1], classes: c, styles: d, attributes: h }, a = a.slice(b[0].length); return n } function y(a, b) { var c = a.match(J[b]); return c ? R(c[1]) : null } function A(a) {
                ...
                var m = 0, f; e.toHtml && (b.name = b.name.replace(F, "$1")); if (e.doCallbacks && a.elementCallbacks) { a: { f = a.elementCallbacks; for (var g = 0, r = f.length, z; g < r; ++g)if (z = f[g](b)) { f = z; break a } f = void 0 } if (f) return f } if (e.doTransform && (f = a._.transformations[b.name])) { A(b); for (g = 0; g < f.length; ++g)n(a, b, f[g]); p(b) } if (e.doFilter) {
                    a: {
                    ...
                    f = a.validClasses; var g = b.attributes, k = b.styles, r = b.classes; z = b.classBackup; var J = b.styleBackup, C, I, K = [], E = [], H = /^data-cke-/; v = !1; delete g.style; delete g["class"]; delete b.classBackup; delete b.styleBackup; if (!a.allAttributes) for (C in g) l[C] || (H.test(C) ? C == (I = C.replace(/^data-cke-saved-/, "")) || l[I] || (delete g[C], v = !0) : (delete g[C], v = !0)); if (!a.allStyles || a.hadInvalidStyle) { for (C in k) a.allStyles || B[C] ? K.push(C + ":" + k[C]) : v = !0; K.length && (g.style = K.sort().join("; ")) } else J && (g.style = J); if (!a.allClasses ||
                        a.hadInvalidClass) { for (C = 0; C < r.length; ++C)(a.allClasses || f[r[C]]) && E.push(r[C]); E.length && (g["class"] = E.sort().join(" ")); z && E.length < z.split(/\s+/).length && (v = !0) } else z && (g["class"] = z); v && (m = 1); if (!e.skipFinalValidation && !x(b)) return h.push(b), 1
                } e.toHtml && (b.name = b.name.replace(L, "cke:$1")); return m
            } function D(a) { var b = [], c; for (c in a) -1 < c.indexOf("*") && b.push(c.replace(/\*/g, ".*")); return b.length ? new RegExp("^(?:" + b.join("|") + ")$") : null } function p(a) {
            ...
            } function x(a) { switch (a.name) { case "a": if (!(a.children.length || a.attributes.name || a.attributes.id)) return !1; break; case "img": if (!a.attributes.src) return !1 }return !0 } function G(a) { if (!a) return !1; if (!0 === a) return !0; var b = D(a); return function (c) { return c in a || b && c.match(b) } } function u() { return new CKEDITOR.htmlParser.element("br") } function r(a) {
                return a.type == CKEDITOR.NODE_ELEMENT && ("br" ==
                    a.name || C.$block[a.name])
            } function h(a, b, c) {
                var d = a.name; if (C.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(u()) : (a.parent && c.push({ check: "it", el: a.parent }), a.remove()); else if (C.$block[d] || "tr" == d) if ("br" == b) a.previous && !r(a.previous) && (b = u(), b.insertBefore(a)), a.next && !r(a.next) && (b = u(), b.insertAfter(a)), a.replaceWithChildren(); else {
                    var d = a.children, h; b: { h = C[b]; for (var n = 0, e = d.length, m; n < e; ++n)if (m = d[n], m.type == CKEDITOR.NODE_ELEMENT && !h[m.name]) { h = !1; break b } h = !0 } if (h) a.name = b, a.attributes =
            ...
            } function n(a, b, c) { var d, h; for (d = 0; d < c.length; ++d)if (h = c[d], !(h.check && !a.check(h.check, !1) || h.left && !h.left(b))) { h.right(b, K); break } } function m(a, b) {
                var c = b.getDefinition(), d = c.attributes, h = c.styles, n, e, m, f; if (a.name != c.element) return !1; for (n in d) if ("class" == n) for (c = d[n].split(/\s+/), m = a.classes.join("|"); f = c.pop();) { if (-1 == m.indexOf(f)) return !1 } else if (a.attributes[n] != d[n]) return !1; for (e in h) if (a.styles[e] !=
            ...
            this.allowedContent = []; this.disallowedContent = []; this.elementCallbacks = null; this.disabled =
                !1; this.editor = null; this.id = CKEDITOR.tools.getNextNumber(); this._ = { allowedRules: { elements: {}, generic: [] }, disallowedRules: { elements: {}, generic: [] }, transformations: {}, cachedTests: {} }; CKEDITOR.filter.instances[this.id] = this; if (a instanceof CKEDITOR.editor) {
                    a = this.editor = a; this.customConfig = !0; var b = a.config.allowedContent; !0 === b ? this.disabled = !0 : (b || (this.customConfig = !1), this.allow(b, "config", 1), this.allow(a.config.extraAllowedContent, "extra", 1), this.allow(T[a.enterMode] + " " + T[a.shiftEnterMode], "default",
                ...
                allow: function (b, c, d) {
                    if (!g(this, b, d)) return !1; var h, n; if ("string" == typeof b) b = f(b); else if (b instanceof CKEDITOR.style) {
                    ...
                    } else if (CKEDITOR.tools.isArray(b)) { for (h = 0; h < b.length; ++h)n = this.allow(b[h], c, d); return n } a(this, b, c, this.allowedContent, this._.allowedRules); return !0
                }, applyTo: function (a, b, c, d) {
                    if (this.disabled) return !1; var n = this, e = [], m = this.editor && this.editor.config.protectedSource, f, g = !1, p = { doFilter: !c, doTransform: !0, doCallbacks: !0, toHtml: b };
                    a.forEach(function (a) {
                        if (a.type == CKEDITOR.NODE_ELEMENT) { if ("off" == a.attributes["data-cke-filter"]) return !1; if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-")) if (f = t(n, a, e, p), f & 1) g = !0; else if (f & 2) return !1 } else if (a.type == CKEDITOR.NODE_COMMENT && a.value.match(/^\{cke_protected\}(?!\{C\})/)) {
                            var c; a: {
                                var d = decodeURIComponent(a.value.replace(/^\{cke_protected\}/, "")); c = []; var h, r, z; if (m) for (r = 0; r < m.length; ++r)if ((z = d.match(m[r])) && z[0].length == d.length) {
                                    c = !0;
                                    break a
                    ...
                    }, null, !0); e.length && (g = !0); var r; a = []; d = T[d || (this.editor ? this.editor.enterMode : CKEDITOR.ENTER_P)]; for (var z; c = e.pop();)c.type == CKEDITOR.NODE_ELEMENT ? h(c, d, a) : c.remove(); for (; r = a.pop();)if (c = r.el, c.parent) switch (z = C[c.parent.name] || C.span, r.check) {
                        case "it": C.$removeEmpty[c.name] && !c.children.length ? h(c, d, a) : x(c) || h(c, d, a); break; case "el-up": c.parent.type ==
                ...
                addContentForms: function (a) { if (!this.disabled && a) { var b, c, d = [], h; for (b = 0; b < a.length && !h; ++b)c = a[b], ("string" == typeof c || c instanceof CKEDITOR.style) && this.check(c) && (h = c); if (h) { for (b = 0; b < a.length; ++b)d.push(z(a[b], h)); this.addTransformations(d) } } }, addElementCallback: function (a) { this.elementCallbacks || (this.elementCallbacks = []); this.elementCallbacks.push(a) }, addFeature: function (a) {
                    ...
                    var b, c; if (!this.disabled && a) {
                        var d = this._.transformations, h; for (h = 0; h < a.length; ++h) {
                            b = a[h]; var n = void 0, e = void 0, m = void 0, f = void 0, g = void 0, r = void 0; c = []; for (e = 0; e < b.length; ++e)m = b[e], "string" == typeof m ? (m = m.split(/\s*:\s*/), f = m[0], g = null, r = m[1]) : (f = m.check, g = m.left, r = m.right), n || (n = m, n = n.element ? n.element : f ? f.match(/^([a-z0-9]+)/i)[0] :
                                n.left.getDefinition().element), g instanceof CKEDITOR.style && (g = B(g)), c.push({ check: f == n ? null : f, left: g, right: "string" == typeof r ? E(r) : r }); b = n; d[b] || (d[b] = []); d[b].push(c)
                        }
                    }
                    ...
                    } else d = a.getDefinition(), h = d.styles, m = d.attributes || {}, h && !CKEDITOR.tools.isEmpty(h) ? (h = H(h), m.style = CKEDITOR.tools.writeCssText(h, !0)) : h = {}, h = { name: d.element, attributes: m, classes: m["class"] ? m["class"].split(/\s+/) : [], styles: h, children: [] }; var m = CKEDITOR.tools.clone(h), g = [], r; if (!1 !== b && (r = this._.transformations[h.name])) {
                        for (d =
                            0; d < r.length; ++d)n(this, h, r[d]); p(h)
                    } t(this, m, g, { doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c }); b = 0 < g.length ? !1 : CKEDITOR.tools.objectCompare(h.attributes, m.attributes, !0) ? !0 : !1; "string" == typeof a && (this._.cachedChecks[e] = b); return b
                }, getAllowedEnterMode: function () {
                    var a = ["p", "div", "br"], b = { p: CKEDITOR.ENTER_P, div: CKEDITOR.ENTER_DIV, br: CKEDITOR.ENTER_BR }; return function (c, d) {
                        var h = a.slice(), n; if (this.check(T[c])) return c; for (d || (h = h.reverse()); n = h.pop();)if (this.check(n)) return b[n];
            ...
            }; var Q = { styles: 1, attributes: 1, classes: 1 }, v = { styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses" }, I = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, J = { styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/ }, F = /^cke:(object|embed|param)$/,
                L = /^(object|embed|param)$/, K; K = CKEDITOR.filter.transformationsTools = {
    ...
    CKEDITOR.scriptLoader = function () {
        var a = {}, d = {}; return {
            load: function (b, c, e, g) {
                var l = "string" == typeof b; l && (b = [b]); e || (e = CKEDITOR); var k = b.length, q = [], w = [], f = function (a) { c && (l ? c.call(e, a) : c.call(e, q, w)) }; if (0 === k) f(!0); else {
                    var y = function (a, b) { (b ? q : w).push(a); 0 >= --k && (g && CKEDITOR.document.getDocumentElement().removeStyle("cursor"), f(b)) }, A = function (b, c) { a[b] = 1; var e = d[b]; delete d[b]; for (var f = 0; f < e.length; f++)e[f](b, c) }, t = function (b) {
                        if (a[b]) y(b, !0); else {
                    ...
                    }; g && CKEDITOR.document.getDocumentElement().setStyle("cursor", "wait"); for (var D = 0; D < k; D++)t(b[D])
                }
            }, queue: function () {
                function a() {
                    var b;
    ...
    CKEDITOR.resourceManager.prototype = {
        add: function (a, d) { if (this.registered[a]) throw Error('[CKEDITOR.resourceManager.add] The resource name "' + a + '" is already registered.'); var b = this.registered[a] = d || {}; b.name = a; b.path = this.getPath(a); CKEDITOR.fire(a + CKEDITOR.tools.capitalize(this.fileName) + "Ready", b); return this.get(a) }, get: function (a) { return this.registered[a] || null }, getPath: function (a) { var d = this.externals[a]; return CKEDITOR.getUrl(d && d.dir || this.basePath + a + "/") }, getFilePath: function (a) {
            ...
            CKEDITOR.tools.isArray(a) || (a = a ? [a] : []); for (var c = this.loaded, e = this.registered, g = [], l = {}, k = {}, q = 0; q < a.length; q++) {
                var w = a[q]; if (w) if (c[w] || e[w]) k[w] = this.get(w); else {
                    var f = this.getFilePath(w); g.push(f); f in l || (l[f] =
                        []); l[f].push(w)
                }
            } CKEDITOR.scriptLoader.load(g, function (a, e) { if (e.length) throw Error('[CKEDITOR.resourceManager.load] Resource name "' + l[e[0]].join(",") + '" was not found at "' + e[0] + '".'); for (var f = 0; f < a.length; f++)for (var g = l[a[f]], p = 0; p < g.length; p++) { var x = g[p]; k[x] = this.get(x); c[x] = 1 } d.call(b, k) }, this)
        }
        ...
        var d = {}; return function (b, c, e) {
            var g = {}, l = function (b) {
                a.call(this, b, function (a) {
                    CKEDITOR.tools.extend(g, a); var b = [], f; for (f in a) { var k = a[f], A = k && k.requires; if (!d[f]) { if (k.icons) for (var t = k.icons.split(","), D = t.length; D--;)CKEDITOR.skin.addIcon(t[D], k.path + "icons/" + (CKEDITOR.env.hidpi && k.hidpi ? "hidpi/" : "") + t[D] + ".png"); d[f] = 1 } if (A) for (A.split && (A = A.split(",")), k = 0; k < A.length; k++)g[A[k]] || b.push(A[k]) } if (b.length) l.call(this,
    ...
    (function () {
        function a(a, e, f) {
        ...
        } function d() { do var a = "editor" + ++t; while (CKEDITOR.instances[a]); return a } function b(a,
            b) { return b == CKEDITOR.ELEMENT_MODE_INLINE ? a.is(CKEDITOR.dtd.$editable) || a.is("textarea") : b == CKEDITOR.ELEMENT_MODE_REPLACE ? !a.is(CKEDITOR.dtd.$nonBodyContent) : 1 } function c() { var a = this.commands, b; for (b in a) e(this, a[b]) } function e(a, b) { b[b.startDisabled ? "disable" : a.readOnly && !b.readOnly ? "disable" : b.modes[a.mode] ? "enable" : "disable"]() } function g(a, b, c) { if (b) { var d, e, h = a.commands; for (e in h) d = h[e], (c || d.contextSensitive) && d.refresh(a, b) } } function l(a) {
                var b = a.config.customConfig; if (!b) return !1; var b =
                    CKEDITOR.getUrl(b), c = D[b] || (D[b] = {}); c.fn ? (c.fn.call(a, a.config), CKEDITOR.getUrl(a.config.customConfig) != b && l(a) || a.fireOnce("customConfigLoaded")) : CKEDITOR.scriptLoader.queue(b, function () { c.fn = CKEDITOR.editorConfig ? CKEDITOR.editorConfig : function () { }; l(a) }); return !0
            } function k(a, b) {
            ...
            } function q(a) { CKEDITOR.skin.loadPart("editor", function () { w(a) }) } function w(a) {
                ...
                var b = a.config, c = b.plugins, d = b.extraPlugins, e =
                    b.removePlugins; if (d) var h = new RegExp("(?:^|,)(?:" + d.replace(/\s*,\s*/g, "|") + ")(?\x3d,|$)", "g"), c = c.replace(h, ""), c = c + ("," + d); if (e) var n = new RegExp("(?:^|,)(?:" + e.replace(/\s*,\s*/g, "|") + ")(?\x3d,|$)", "g"), c = c.replace(n, ""); CKEDITOR.env.air && (c += ",adobeair"); CKEDITOR.plugins.load(c.split(","), function (c) {
                        var d = [], h = [], e = []; a.plugins = c; for (var f in c) {
                            var g = c[f], r = g.lang, l = null, k = g.requires, v; CKEDITOR.tools.isArray(k) && (k = k.join(",")); if (k && (v = k.match(n))) for (; k = v.pop();)CKEDITOR.error("editor-plugin-required",
                                { plugin: k.replace(",", ""), requiredBy: f }); r && !a.lang[f] && (r.split && (r = r.split(",")), 0 <= CKEDITOR.tools.indexOf(r, a.langCode) ? l = a.langCode : (l = a.langCode.replace(/-.*/, ""), l = l != a.langCode && 0 <= CKEDITOR.tools.indexOf(r, l) ? l : 0 <= CKEDITOR.tools.indexOf(r, "en") ? "en" : r[0]), g.langEntries && g.langEntries[l] ? (a.lang[f] = g.langEntries[l], l = null) : e.push(CKEDITOR.getUrl(g.path + "lang/" + l + ".js"))); h.push(l); d.push(g)
            ...
            } a.prototype = CKEDITOR.editor.prototype; CKEDITOR.editor = a; var t = 0, D = {}; CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
    ...
    (function () {
        function a(a) { return a.attributes["data-cke-survive"] ? !1 : "a" == a.name && a.attributes.href || CKEDITOR.dtd.$removeEmpty[a.name] } var d = CKEDITOR.tools.extend({ table: 1, ul: 1, ol: 1, dl: 1 }, CKEDITOR.dtd.table, CKEDITOR.dtd.ul, CKEDITOR.dtd.ol, CKEDITOR.dtd.dl), b = { ol: 1, ul: 1 }, c = CKEDITOR.tools.extend({}, { html: 1 }, CKEDITOR.dtd.html, CKEDITOR.dtd.body, CKEDITOR.dtd.head, { style: 1, script: 1 }), e = { ul: "li", ol: "li", dl: "dd", table: "tbody", tbody: "tr", thead: "tr", tfoot: "tr", tr: "td" }; CKEDITOR.htmlParser.fragment.fromHtml =
            function (g, l, k) {
                function q(a) { var b; if (0 < x.length) for (var c = 0; c < x.length; c++) { var d = x[c], h = d.name, e = CKEDITOR.dtd[h], f = u.name && CKEDITOR.dtd[u.name]; f && !f[h] || a && e && !e[a] && CKEDITOR.dtd[a] ? h == u.name && (y(u, u.parent, 1), c--) : (b || (w(), b = 1), d = d.clone(), d.parent = u, u = d, x.splice(c, 1), c--) } } function w() { for (; G.length;)y(G.shift(), u) } function f(a) {
                ...
                } function y(b, c, d) { c = c || u || p; var e = u; void 0 === b.previous && (A(c, b) && (u = c, D.onTagOpen(k, {}), b.returnPoint = c = u), f(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (h = !1), "textarea" == b.name && (r = !1)); b.returnPoint ? (u = b.returnPoint, delete b.returnPoint) : u = d ? c : e } function A(a, b) {
                ...
                } function t(a, b) { return a in CKEDITOR.dtd.$listItem || a in CKEDITOR.dtd.$tableContent ? a == b || "dt" == a && "dd" == b || "dd" == a && "dt" == b : !1 } var D = new CKEDITOR.htmlParser, p = l instanceof CKEDITOR.htmlParser.element ? l : "string" == typeof l ? new CKEDITOR.htmlParser.element(l) : new CKEDITOR.htmlParser.fragment, x = [], G = [], u = p, r = "textarea" == p.name, h = "pre" == p.name; D.onTagOpen = function (e, m, f, g) {
                    m = new CKEDITOR.htmlParser.element(e, m); m.isUnknown && f && (m.isEmpty = !0); m.isOptionalClose = g;
                    if (a(m)) x.push(m); else {
                        if ("pre" == e) h = !0; else { if ("br" == e && h) { u.add(new CKEDITOR.htmlParser.text("\n")); return } "textarea" == e && (r = !0) } if ("br" == e) G.push(m); else {
                            for (; !(g = (f = u.name) ? CKEDITOR.dtd[f] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, m.isUnknown || u.isUnknown || g[e]);)if (u.isOptionalClose) D.onTagClose(f); else if (e in b && f in b) f = u.children, (f = f[f.length - 1]) && "li" == f.name || y(f = new CKEDITOR.htmlParser.element("li"), u), !m.returnPoint && (m.returnPoint = u), u = f; else if (e in CKEDITOR.dtd.$listItem &&
                                !t(e, f)) D.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1); else if (f in d && !t(e, f)) !m.returnPoint && (m.returnPoint = u), u = u.parent; else if (f in CKEDITOR.dtd.$inline && x.unshift(u), u.parent) y(u, u.parent, 1); else { m.isOrphan = 1; break } q(e); w(); m.parent = u; m.isEmpty ? y(m) : u = m
                        }
                    }
                }; D.onTagClose = function (a) {
                    for (var b = x.length - 1; 0 <= b; b--)if (a == x[b].name) { x.splice(b, 1); return } for (var c = [], d = [], h = u; h != p && h.name != a;)h._.isBlockLike || d.unshift(h), c.push(h), h = h.returnPoint || h.parent; if (h != p) {
                        for (b = 0; b < c.length; b++) { var e = c[b]; y(e, e.parent) } u =
                            h; h._.isBlockLike && w(); y(h, h.parent); h == u && (u = u.parent); x = x.concat(d)
                    } "body" == a && (k = !1)
                }; D.onText = function (a) { if (!(u._.hasInlineStarted && !G.length || h || r) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return; var b = u.name, f = b ? CKEDITOR.dtd[b] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c; if (!r && !f["#"] && b in d) D.onTagOpen(e[b] || ""), D.onText(a); else { w(); q(); h || r || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " ")); a = new CKEDITOR.htmlParser.text(a); if (A(u, a)) this.onTagOpen(k, {}, 0, 1); u.add(a) } }; D.onCDATA =
                    function (a) { u.add(new CKEDITOR.htmlParser.cdata(a)) }; D.onComment = function (a) { w(); q(); u.add(new CKEDITOR.htmlParser.comment(a)) }; D.parse(g); for (w(); u != p;)y(u, u.parent, 1); f(p); return p
        ...
        function a() { this.rules = [] } function d(b, c, d, g) { var l, k; for (l in c) (k = b[l]) || (k = b[l] = new a), k.add(c[l], d, g) } CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
            ...
            add: function (a, c, d) { this.rules.splice(this.findIndex(c), 0, { value: a, priority: c, options: d }) }, addMany: function (a,
                c, d) { for (var g = [this.findIndex(c), 0], l = 0, k = a.length; l < k; l++)g.push({ value: a[l], priority: c, options: d }); this.rules.splice.apply(this.rules, g) }, findIndex: function (a) { for (var c = this.rules, d = c.length - 1; 0 <= d && a < c[d].priority;)d--; return d + 1 }, exec: function (a, c) {
                    var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment, g = Array.prototype.slice.call(arguments, 1), l = this.rules, k = l.length, q, w, f, y; for (y = 0; y < k; y++)if (d && (q = c.type, w = c.name), f = l[y], !(a.nonEditable && !f.options.applyToAll ||
                        a.nestedEditable && f.options.excludeNestedEditable)) { f = f.value.apply(null, g); if (!1 === f || d && f && (f.name != w || f.type != q)) return f; null != f && (g[0] = c = f) } return c
    ...
    (function () {
        function a(a, d) {
            function m(a) { return a || CKEDITOR.env.needsNbspFiller ? new CKEDITOR.htmlParser.text(" ") : new CKEDITOR.htmlParser.element("br", { "data-cke-bogus": 1 }) } function n(a, d) {
                return function (h) {
                    if (h.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var e = [], n = b(h), r, F; if (n) for (f(n, 1) && e.push(n); n;)g(n) && (r = c(n)) && f(r) && ((F = c(r)) && !g(F) ? e.push(r) : (m(v).insertAfter(r), r.remove())), n = n.previous; for (n = 0; n < e.length; n++)e[n].remove(); if (e = !a || !1 !== ("function" == typeof d ? d(h) : d)) v || CKEDITOR.env.needsBrFiller ||
                            h.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? v || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || h.name in CKEDITOR.dtd.tr || h.name in CKEDITOR.dtd.$listItem) ? (e = b(h), e = !e || "form" == h.name && "input" == e.name) : e = !1 : e = !1; e && h.add(m(a))
                    }
                }
            } function f(a, b) {
            ...
            } var r = { elements: {} }, v = "html" == d, z = CKEDITOR.tools.extend({}, h), E; for (E in z) "#" in u[E] || delete z[E]; for (E in z) r.elements[E] = n(v, a.config.fillEmptyBlocks); r.root = n(v, !1); r.elements.br = function (a) {
                return function (b) {
        ...
        } function l(a, b) { var c = a.children[a.children.length - 1]; a.children.push(b); b.parent = a; c && (c.next = b, b.previous = c) } function k(a) { a = a.attributes; "false" != a.contenteditable && (a["data-cke-editable"] = a.contenteditable ? "true" : 1); a.contenteditable = "false" } function q(a) { a = a.attributes; switch (a["data-cke-editable"]) { case "true": a.contenteditable = "true"; break; case "1": delete a.contenteditable } } function w(a) {
            return a.replace(E,
                function (a, b, c) { return "\x3c" + b + c.replace(C, function (a, b) { return H.test(b) && -1 == c.indexOf("data-cke-saved-" + b) ? " data-cke-saved-" + a + " data-cke-" + CKEDITOR.rnd + "-" + a : a }) + "\x3e" })
        } function f(a, b) { return a.replace(b, function (a, b, c) { 0 === a.indexOf("\x3ctextarea") && (a = b + t(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") + "\x3c/textarea\x3e"); return "\x3ccke:encoded\x3e" + encodeURIComponent(a) + "\x3c/cke:encoded\x3e" }) } function y(a) { return a.replace(Q, function (a, b) { return decodeURIComponent(b) }) } function A(a) {
            return a.replace(/\x3c!--(?!{cke_protected})[\s\S]+?--\x3e/g,
                function (a) { return "\x3c!--" + G + "{C}" + encodeURIComponent(a).replace(/--/g, "%2D%2D") + "--\x3e" })
        } function t(a) { return a.replace(/\x3c!--\{cke_protected\}\{C\}([\s\S]+?)--\x3e/g, function (a, b) { return decodeURIComponent(b) }) } function D(a, b) { var c = b._.dataStore; return a.replace(/\x3c!--\{cke_protected\}([\s\S]+?)--\x3e/g, function (a, b) { return decodeURIComponent(b) }).replace(/\{cke_protected_(\d+)\}/g, function (a, b) { return c && c[b] || "" }) } function p(a, b) {
            var c = [], d = b.config.protectedSource, h = b._.dataStore || (b._.dataStore =
                ...
                }); a = a.replace(/<\w+(?:\s+(?:(?:[^\s=>]+\s*=\s*(?:[^'"\s>]+|'[^']*'|"[^"]*"))|[^\s=\/>]+))+\s*\/?>/g, function (a) { return a.replace(/\x3c!--\{cke_protected\}([^>]*)--\x3e/g, function (a, b) { h[h.id] = decodeURIComponent(b); return "{cke_protected_" + h.id++ + "}" }) }); return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function (a, c, d, h) { return "\x3c" + c + d + "\x3e" + D(t(h), b) + "\x3c/" + c + "\x3e" })
            ...
            h, e = this; this.editor = b; this.dataFilter = c = new CKEDITOR.htmlParser.filter; this.htmlFilter = h = new CKEDITOR.htmlParser.filter; this.writer = new CKEDITOR.htmlParser.basicWriter; c.addRules(n); c.addRules(m, { applyToAll: !0 }); c.addRules(a(b, "data"), { applyToAll: !0 }); h.addRules(z); h.addRules(B, { applyToAll: !0 }); h.addRules(a(b, "html"), { applyToAll: !0 }); b.on("toHtml", function (a) {
                a = a.data; var c = a.dataValue, h, c = p(c, b), c = f(c, T), c = w(c), c = f(c, R), c = c.replace(v, "$1cke:$2"), c = c.replace(J, "\x3ccke:$1$2\x3e\x3c/cke:$1\x3e"),
                ...
                a.data.filter.applyTo(a.data.dataValue,
                    !1, !0)
            }, null, null, 11); b.on("toDataFormat", function (a) { var c = a.data.dataValue, d = e.writer; d.reset(); c.writeChildrenHtml(d); c = d.getHtml(!0); c = t(c); c = D(c, b); a.data.dataValue = c }, null, null, 15)
        }; CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function (a, b, c, d) {
                var h = this.editor, e, m, n, f; b && "object" == typeof b ? (e = b.context, c = b.fixForBody, d = b.dontFilter, m = b.filter, n = b.enterMode, f = b.protectedWhitespaces) : e = b; e || null === e || (e = h.editable().getName()); return h.fire("toHtml", {
            ...
            }; CKEDITOR.env.ie && (B.attributes.style = function (a) { return a.replace(/(^|;)([^\:]+)/g, function (a) { return a.toLowerCase() }) }); var E = /<(a|area|img|input|source)\b([^>]*)>/gi, C = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, H = /^(href|src|name)$/i, R = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
    ...
    (function () {
        function a(a) { return function (b) { return b.type == CKEDITOR.NODE_ELEMENT && ("string" == typeof a ? b.name == a : b.name in a) } } var d = function (a, b) { a = a[0]; b = b[0]; return a < b ? -1 : a > b ? 1 : 0 }, b = CKEDITOR.htmlParser.fragment.prototype; CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function () { return new CKEDITOR.htmlParser.element(this.name, this.attributes) }, filter: function (a, b) {
                ...
                if (!d.parent) a.onRoot(b, d); for (; ;) { l = d.name; if (!(k = a.onElementName(b, l))) return this.remove(), !1; d.name = k; if (!(d = a.onElement(b, d))) return this.remove(), !1; if (d !== this) return this.replaceWith(d), !1; if (d.name == l) break; if (d.type != CKEDITOR.NODE_ELEMENT) return this.replaceWith(d), !1; if (!d.name) return this.replaceWithChildren(), !1 } l = d.attributes; var q, w; for (q in l) {
                    for (k = l[q]; ;)if (w = a.onAttributeName(b, q)) if (w != q) delete l[q], q = w; else break; else { delete l[q]; break } w && (!1 === (k = a.onAttribute(b, d, w, k)) ? delete l[w] :
                        l[w] = k)
    ...
    (function () {
        ...
        (this._.modes || (this._.modes =
            ...
            var d = this, l = this._.modes; if (a != d.mode && l && l[a]) {
                d.fire("beforeSetMode", a); if (d.mode) { var k = d.checkDirty(), l = d._.previousModeData, q, w = 0; d.fire("beforeModeUnload"); d.editable(0); d._.previousMode = d.mode; d._.previousModeData = q = d.getData(1); "source" == d.mode && l == q && (d.fire("lockSnapshot", { forceUpdate: !0 }), w = 1); d.ui.space("contents").setHtml(""); d.mode = "" } else d._.previousModeData = d.getData(1); this._.modes[a](function () {
                d.mode = a; void 0 !== k && !k &&
            ...
            var k = this.container, q = this.ui.space("contents"), w = CKEDITOR.env.webkit && this.document && this.document.getWindow().$.frameElement; l = l ? this.container.getFirst(function (a) { return a.type == CKEDITOR.NODE_ELEMENT && a.hasClass("cke_inner") }) : k; l.setSize("width", a, !0); w && (w.style.width = "1%"); var f = (l.$.offsetHeight || 0) - (q.$.clientHeight ||
                0), k = Math.max(b - (d ? 0 : f), 0); b = d ? b + f : b; q.setStyle("height", k + "px"); w && (w.style.width = "100%"); this.fire("resize", { outerHeight: b, contentsHeight: k, outerWidth: a || l.getSize("width") })
    ...
    (function () {
        function a(a) {
            var b = a.editor, e = a.data.path, m = e.blockLimit, f = a.data.selection, g = f.getRanges()[0], E; if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller) if (f = d(f, e)) f.appendBogus(), E = CKEDITOR.env.ie; l(b, e.block, m) && g.collapsed && !g.getCommonAncestor().isReadOnly() && (e = g.clone(), e.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), m = new CKEDITOR.dom.walker(e), m.guard = function (a) { return !c(a) || a.type == CKEDITOR.NODE_COMMENT || a.isReadOnly() }, !m.checkForward() || e.checkStartOfBlock() && e.checkEndOfBlock()) &&
                (b = g.fixBlock(!0, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p"), CKEDITOR.env.needsBrFiller || (b = b.getFirst(c)) && b.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(b.getText()).match(/^(?:&nbsp;|\xa0)$/) && b.remove(), E = 1, a.cancel()); E && g.select()
            ...
            function b(a) { return function (b, h) { h && b.type == CKEDITOR.NODE_ELEMENT && b.is(f) && (d = b); if (!(h || !c(b) || a && t(b))) return !1 } } var d, e = a.getRanges()[0]; a = a.root;
        ...
        function k(a) { return a.activeEnterMode != CKEDITOR.ENTER_BR && !1 !== a.config.autoParagraph ? a.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p" : !1 } function q(a) { var b = a.editor; b.getSelection().scrollIntoView(); setTimeout(function () { b.fire("saveSnapshot") }, 0) } function w(a, b, c) { var d = a.getCommonAncestor(b); for (b = a = c ? b : a; (a = a.getParent()) && !d.equals(a) && 1 == a.getChildCount();)b = a; b.remove() } var f, y, A, t, D, p, x, G, u; CKEDITOR.editable = CKEDITOR.tools.createClass({
            base: CKEDITOR.dom.element, $: function (a, b) {
                ...
                on: function (a, b) { var c = Array.prototype.slice.call(arguments, 0); CKEDITOR.env.ie && /^focus|blur$/.exec(a) && (a = "focus" == a ? "focusin" : "focusout", b = e(b, this), c[0] = a, c[1] = b); return CKEDITOR.dom.element.prototype.on.apply(this, c) }, attachListener: function (a) { !this._.listeners && (this._.listeners = []); var b = Array.prototype.slice.call(arguments, 1), b = a.on.apply(a, b); this._.listeners.push(b); return b }, clearListeners: function () { var a = this._.listeners; try { for (; a.length;)a.pop().removeListener() } catch (b) { } }, restoreAttrs: function () {
                    ...
                    this.editor.focus(); this.insertHtml(this.transformPlainTextToHtml(a),
                        "text")
                }, transformPlainTextToHtml: function (a) { var b = this.editor.getSelection().getStartElement().hasAscendant("pre", !0) ? CKEDITOR.ENTER_BR : this.editor.activeEnterMode; return CKEDITOR.tools.transformPlainTextToHtml(a, b) }, insertHtml: function (a, b, c) { var d = this.editor; d.focus(); d.fire("saveSnapshot"); c || (c = d.getSelection().getRanges()[0]); p(this, b || "html", a, c); c.select(); q(this); this.editor.fire("afterInsertHtml", {}) }, insertHtmlIntoRange: function (a, b, c) {
                    p(this, c || "html", a, b); this.editor.fire("afterInsertHtml",
                        { intoRange: b })
                }, insertElement: function (a, b) {
                    var d = this.editor; d.focus(); d.fire("saveSnapshot"); var e = d.activeEnterMode, d = d.getSelection(), f = a.getName(), f = CKEDITOR.dtd.$block[f]; b || (b = d.getRanges()[0]); this.insertElementIntoRange(a, b) && (b.moveToPosition(a, CKEDITOR.POSITION_AFTER_END), f && ((f = a.getNext(function (a) { return c(a) && !t(a) })) && f.type == CKEDITOR.NODE_ELEMENT && f.is(CKEDITOR.dtd.$block) ? f.getDtd()["#"] ? b.moveToElementEditStart(f) : b.moveToElementEditEnd(a) : f || e == CKEDITOR.ENTER_BR || (f = b.fixBlock(!0,
                    ...
                    var c = this.editor, d = c.config.enterMode, e = a.getName(), f = CKEDITOR.dtd.$block[e]; if (b.checkReadOnly()) return !1; b.deleteContents(1); b.startContainer.type == CKEDITOR.NODE_ELEMENT && b.startContainer.is({ tr: 1, table: 1, tbody: 1, thead: 1, tfoot: 1 }) && x(b); var g, l; if (f) for (; (g = b.getCommonAncestor(0, 1)) && (l = CKEDITOR.dtd[g.getName()]) &&
                ...
                }, getHtmlFromRange: function (a) { if (a.collapsed) return new CKEDITOR.dom.documentFragment(a.document); a = { doc: this.getDocument(), range: a.clone() }; G.eol.detect(a, this); G.bogus.exclude(a); G.cell.shrink(a); a.fragment = a.range.cloneContents(); G.tree.rebuild(a, this); G.eol.fix(a, this); return new CKEDITOR.dom.documentFragment(a.fragment.$) },
                        ...
                        "afterSetData", function () { this.setData(a.getData(1)) }, this); this.attachListener(a, "loadSnapshot", function (a) { this.setData(a.data, 1) }, this); this.attachListener(a, "beforeFocus", function () { var b = a.getSelection(); (b = b && b.getNative()) && "Control" == b.type || this.focus() }, this); this.attachListener(a, "insertHtml", function (a) { this.insertHtml(a.data.dataValue, a.data.mode, a.data.range) }, this); this.attachListener(a, "insertElement", function (a) { this.insertElement(a.data) }, this); this.attachListener(a, "insertText",
                            ...
                            a.document = this.getDocument(); a.window = this.getWindow(); var d = a.document; this.changeAttr("spellcheck", !a.config.disableNativeSpellChecker); var e = a.config.contentsLangDirection; this.getDirection(1) !=
                                e && this.changeAttr("dir", e); var m = CKEDITOR.getCss(); if (m) { var e = d.getHead(), l = e.getCustomData("stylesheet"); l ? m != l.getText() && (CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? l.$.styleSheet.cssText = m : l.setText(m)) : (m = d.appendStyleText(m), m = new CKEDITOR.dom.element(m.ownerNode || m.owningElement), e.setCustomData("stylesheet", m), m.data("cke-temp", 1)) } e = d.getCustomData("stylesheet_ref") || 0; d.setCustomData("stylesheet_ref", e + 1); this.setCustomData("cke_includeReadonly", !a.config.disableReadonlyStyling); this.attachListener(this,
                                    "click", function (a) { a = a.data; var b = (new CKEDITOR.dom.elementPath(a.getTarget(), this)).contains("a"); b && 2 != a.$.button && b.isReadOnly() && a.preventDefault() }); var k = { 8: 1, 46: 1 }; this.attachListener(a, "key", function (b) {
                                        if (a.readOnly) return !0; var c = b.data.domEvent.getKey(), d; if (c in k) {
                                            b = a.getSelection(); var h, e = b.getRanges()[0], m = e.startPath(), n, l, z, c = 8 == c; CKEDITOR.env.ie && 11 > CKEDITOR.env.version && (h = b.getSelectedElement()) || (h = g(b)) ? (a.fire("saveSnapshot"), e.moveToPosition(h, CKEDITOR.POSITION_BEFORE_START),
                                        ...
                                        this.attachListener(this, "mouseup", function (b) { (b = b.data.getTarget()) && b.is("img") && a.getSelection().selectElement(b) }); CKEDITOR.env.gecko && this.attachListener(this, "mouseup", function (b) { if (2 == b.data.$.button && (b = b.data.getTarget(), !b.getOuterHtml().replace(D, ""))) { var c = a.createRange(); c.moveToElementEditStart(b); c.select(!0) } }); CKEDITOR.env.webkit && (this.attachListener(this, "click", function (a) { a.data.getTarget().is("input", "select") && a.data.preventDefault() }), this.attachListener(this, "mouseup",
                                            function (a) { a.data.getTarget().is("input", "textarea") && a.data.preventDefault() })); CKEDITOR.env.webkit && this.attachListener(a, "key", function (b) {
                                                if (a.readOnly) return !0; b = b.data.domEvent.getKey(); if (b in k) {
                                                    var c = 8 == b, d = a.getSelection().getRanges()[0]; b = d.startPath(); if (d.collapsed) a: {
                                                        var h = b.block; if (h && d[c ? "checkStartOfBlock" : "checkEndOfBlock"]() && d.moveToClosestEditablePosition(h, !c) && d.collapsed) {
                                                            ...
                                                            } d = d.startPath().block; if (!d || d && d.contains(h)) b = void 0; else { a.fire("saveSnapshot"); var f; (f = (c ? d : h).getBogus()) && f.remove(); f = a.getSelection(); e = f.createBookmarks(); (c ? h : d).moveChildren(c ? d : h, !1); b.lastElement.mergeSiblings(); w(h, d, !c); f.selectBookmarks(e); b = !0 }
                                                        } else b = !1
                                                        ...
                                                        c.deleteContents(), d.getParent() && (d.moveChildren(f, !1), b.lastElement.mergeSiblings(), w(f, d, !0)), c = a.getSelection().getRanges()[0], c.collapse(1), c.optimize(), "" === c.startContainer.getHtml() && c.startContainer.appendBogus(), c.select(), b = !0) : b = !1; if (!b) return; a.getSelection().scrollIntoView(); a.fire("saveSnapshot"); return !1
                                                }
                                            }, this, null, 100)
                            }
                }
        ...
        }); CKEDITOR.addCss(".cke_editable{cursor:text}.cke_editable img,.cke_editable input,.cke_editable textarea{cursor:default}"); f = CKEDITOR.dom.walker.whitespaces(!0); y = CKEDITOR.dom.walker.bookmark(!1, !0); A = CKEDITOR.dom.walker.empty(); t = CKEDITOR.dom.walker.bogus(); D = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi; p = function () {
            function a(b) {
                return b.type ==
                    CKEDITOR.NODE_ELEMENT
            } function b(c, d) {
                var e, f, m, n, g = [], l = d.range.startContainer; e = d.range.startPath(); for (var l = C[l.getName()], z = 0, k = c.getChildren(), E = k.count(), B = -1, p = -1, q = 0, w = e.contains(C.$list); z < E; ++z)e = k.getItem(z), a(e) ? (m = e.getName(), w && m in CKEDITOR.dtd.$list ? g = g.concat(b(e, d)) : (n = !!l[m], "br" != m || !e.data("cke-eol") || z && z != E - 1 || (q = (f = z ? g[z - 1].node : k.getItem(z + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && C.$block[f.getName()]), -1 != B || n || (B = z), n || (p = z), g.push({
                    isElement: 1, isLineBreak: q, isBlock: e.isBlockBoundary(),
                    hasBlockSibling: f, node: e, name: m, allowed: n
                }), f = q = 0)) : g.push({ isElement: 0, node: e, allowed: 1 }); -1 < B && (g[B].firstNotAllowed = 1); -1 < p && (g[p].lastNotAllowed = 1); return g
            } function d(b, c) { var e = [], h = b.getChildren(), f = h.count(), m, g = 0, l = C[c], z = !b.is(C.$inline) || b.is("br"); for (z && e.push(" "); g < f; g++)m = h.getItem(g), a(m) && !m.is(l) ? e = e.concat(d(m, c)) : e.push(m); z && e.push(" "); return e } function e(b) { return a(b.startContainer) && b.startContainer.getChild(b.startOffset - 1) } function f(b) {
                return b && a(b) && (b.is(C.$removeEmpty) ||
                    b.is("a") && !b.isBlockBoundary())
            } function g(b, c, d, e) { var h = b.clone(), f, m; h.setEndAt(c, CKEDITOR.POSITION_BEFORE_END); (f = (new CKEDITOR.dom.walker(h)).next()) && a(f) && p[f.getName()] && (m = f.getPrevious()) && a(m) && !m.getParent().equals(b.startContainer) && d.contains(m) && e.contains(f) && f.isIdentical(m) && (f.moveChildren(m), f.remove(), g(b, c, d, e)) } function E(b, c) {
            ...
            } var C = CKEDITOR.dtd, p = { p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1 }, q = { p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1 }, w = CKEDITOR.tools.extend({}, C.$inline); delete w.br; return function (p, v, I, J) {
                var F = p.editor, L = !1; "unfiltered_html" == v && (v = "html", L = !0); if (!J.checkReadOnly()) {
                    var K = (new CKEDITOR.dom.elementPath(J.startContainer, J.root)).blockLimit || J.root; p = {
                        type: v, dontFilter: L, editable: p,
                        editor: F, range: J, blockLimit: K, mergeCandidates: [], zombies: []
                    }; v = p.range; J = p.mergeCandidates; var H, t; "text" == p.type && v.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (H = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", v.document), v.insertNode(H), v.setStartAfter(H)); L = new CKEDITOR.dom.elementPath(v.startContainer); p.endPath = K = new CKEDITOR.dom.elementPath(v.endContainer); if (!v.collapsed) {
                        var F = K.block || K.blockLimit, x = v.getCommonAncestor(); F && !F.equals(x) && !F.contains(x) && v.checkEndOfBlock() &&
                            p.zombies.push(F); v.deleteContents()
                    } for (; (t = e(v)) && a(t) && t.isBlockBoundary() && L.contains(t);)v.moveToPosition(t, CKEDITOR.POSITION_BEFORE_END); g(v, p.blockLimit, L, K); H && (v.setEndBefore(H), v.collapse(), H.remove()); H = v.startPath(); if (F = H.contains(f, !1, 1)) v.splitElement(F), p.inlineStylesRoot = F, p.inlineStylesPeak = H.lastElement; H = v.createBookmark(); (F = H.startNode.getPrevious(c)) && a(F) && f(F) && J.push(F); (F = H.startNode.getNext(c)) && a(F) && f(F) && J.push(F); for (F = H.startNode; (F = F.getParent()) && f(F);)J.push(F);
                    v.moveToBookmark(H); if (H = I) {
                        H = p.range; if ("text" == p.type && p.inlineStylesRoot) { t = p.inlineStylesPeak; v = t.getDocument().createText("{cke-peak}"); for (J = p.inlineStylesRoot.getParent(); !t.equals(J);)v = v.appendTo(t.clone()), t = t.getParent(); I = v.getOuterHtml().split("{cke-peak}").join(I) } t = p.blockLimit.getName(); if (/^\s+|\s+$/.test(I) && "span" in CKEDITOR.dtd[t]) { var A = '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e'; I = A + I + A } I = p.editor.dataProcessor.toHtml(I, {
                        ...
                        }); t = H.document.createElement("body"); t.setHtml(I); A && (t.getFirst().remove(), t.getLast().remove()); if ((A = H.startPath().block) && (1 != A.getChildCount() || !A.getBogus())) a: { var y; if (1 == t.getChildCount() && a(y = t.getFirst()) && y.is(q) && !y.hasAttribute("contenteditable")) { A = y.getElementsByTag("*"); H = 0; for (J = A.count(); H < J; H++)if (v = A.getItem(H), !v.is(w)) break a; y.moveChildren(y.getParent(1)); y.remove() } } p.dataWrapper = t; H = I
                    } if (H) {
                        y =
                        p.range; H = y.document; var u; t = p.blockLimit; J = 0; var D, A = [], M, G; I = F = 0; var P, W; v = y.startContainer; var L = p.endPath.elements[0], X, K = L.getPosition(v), x = !!L.getCommonAncestor(v) && K != CKEDITOR.POSITION_IDENTICAL && !(K & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED); v = b(p.dataWrapper, p); for (E(v, y); J < v.length; J++) {
                            K = v[J]; if (u = K.isLineBreak) {
                                u = y; P = t; var S = void 0, aa = void 0; K.hasBlockSibling ? u = 1 : (S = u.startContainer.getAscendant(C.$block, 1)) && S.is({ div: 1, p: 1 }) ? (aa = S.getPosition(P), aa == CKEDITOR.POSITION_IDENTICAL ||
                                    aa == CKEDITOR.POSITION_CONTAINS ? u = 0 : (P = u.splitElement(S), u.moveToPosition(P, CKEDITOR.POSITION_AFTER_START), u = 1)) : u = 0
                            } if (u) I = 0 < J; else {
                                u = y.startPath(); !K.isBlock && l(p.editor, u.block, u.blockLimit) && (G = k(p.editor)) && (G = H.createElement(G), G.appendBogus(), y.insertNode(G), CKEDITOR.env.needsBrFiller && (D = G.getBogus()) && D.remove(), y.moveToPosition(G, CKEDITOR.POSITION_BEFORE_END)); if ((u = y.startPath().block) && !u.equals(M)) { if (D = u.getBogus()) D.remove(), A.push(u); M = u } K.firstNotAllowed && (F = 1); if (F && K.isElement) {
                                    u =
                                    y.startContainer; for (P = null; u && !C[u.getName()][K.name];) { if (u.equals(t)) { u = null; break } P = u; u = u.getParent() } if (u) P && (W = y.splitElement(P), p.zombies.push(W), p.zombies.push(P)); else { P = t.getName(); X = !J; u = J == v.length - 1; P = d(K.node, P); for (var S = [], aa = P.length, ca = 0, ea = void 0, Y = 0, U = -1; ca < aa; ca++)ea = P[ca], " " == ea ? (Y || X && !ca || (S.push(new CKEDITOR.dom.text(" ")), U = S.length), Y = 1) : (S.push(ea), Y = 0); u && U == S.length && S.pop(); X = S }
                                } if (X) { for (; u = X.pop();)y.insertNode(u); X = 0 } else y.insertNode(K.node); K.lastNotAllowed && J <
                                    v.length - 1 && ((W = x ? L : W) && y.setEndAt(W, CKEDITOR.POSITION_AFTER_START), F = 0); y.collapse()
                            }
                        } 1 != v.length ? D = !1 : (D = v[0], D = D.isElement && "false" == D.node.getAttribute("contenteditable")); D && (I = !0, u = v[0].node, y.setStartAt(u, CKEDITOR.POSITION_BEFORE_START), y.setEndAt(u, CKEDITOR.POSITION_AFTER_END)); p.dontMoveCaret = I; p.bogusNeededBlocks = A
                    } D = p.range; var O; W = p.bogusNeededBlocks; for (X = D.createBookmark(); M = p.zombies.pop();)M.getParent() && (G = D.clone(), G.moveToElementEditStart(M), G.removeEmptyBlocksAtEnd()); if (W) for (; M =
        ...
        G = {
            ...
            function c(a, b) { var d = new CKEDITOR.dom.range(a); d.setStartAfter(b.startNode); d.setEndBefore(b.endNode); return d } return {
                list: {
                    ...
                    function a(c) {
                        var e = [], f, h = new CKEDITOR.dom.walker(c), g = c.startPath().contains(d), m = c.endPath().contains(d), n = {}; h.guard = function (a, h) {
                            if (a.type == CKEDITOR.NODE_ELEMENT) { var l = "visited_" + (h ? "out" : "in"); if (a.getCustomData(l)) return; CKEDITOR.dom.element.setMarker(n, a, l, 1) } if (h && g && a.equals(g)) f = c.clone(), f.setEndAt(g, CKEDITOR.POSITION_BEFORE_END), e.push(f); else if (!h && m && a.equals(m)) f = c.clone(), f.setStartAt(m, CKEDITOR.POSITION_AFTER_START), e.push(f);
                            else { if (l = !h) l = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!g || b(a, g)) && (!m || b(a, m)); l && (f = c.clone(), f.selectNodeContents(a), e.push(f)) }
                        }; h.lastForward(); CKEDITOR.dom.element.clearAllMarkers(n); return e
                        ...
                        detectPurge: function (a) {
                            ...
                            var h = c(f, e.bookmark), g = h.clone(), l, k, v = h.getCommonAncestor(); v.is(CKEDITOR.dtd.$tableContent) && !v.is(d) && (v = v.getAscendant("table",
                    ...
                    var c = b.startPath(), d; l(a, c.block, c.blockLimit) && (d = k(a)) && (d = b.document.createElement(d), d.appendBogus(),
    ...
    (function () {
        function a() { var a = this._.fakeSelection, b; a && (b = this.getSelection(1), b && b.isHidden() || (a.reset(), a = 0)); if (!a && (a = b || this.getSelection(1), !a || a.getType() == CKEDITOR.SELECTION_NONE)) return; this.fire("selectionCheck", a); b = this.elementPath(); b.compare(this._.selectionPreviousPath) || (CKEDITOR.env.webkit && (this._.previousActive = this.document.getActive()), this._.selectionPreviousPath = b, this.fire("selectionChange", { selection: a, path: b })) } function d() {
            A = !0; y || (b.call(this), y = CKEDITOR.tools.setTimeout(b,
                200, this))
        } function b() { y = null; A && (CKEDITOR.tools.setTimeout(a, 0, this), A = !1) } function c(a) { return t(a) || a.type == CKEDITOR.NODE_ELEMENT && !a.is(CKEDITOR.dtd.$empty) ? !0 : !1 } function e(a) {
            function b(c, d) { return c && c.type != CKEDITOR.NODE_TEXT ? a.clone()["moveToElementEdit" + (d ? "End" : "Start")](c) : !1 } if (!(a.root instanceof CKEDITOR.editable)) return !1; var d = a.startContainer, e = a.getPreviousNode(c, null, d), f = a.getNextNode(c, null, d); return b(e) || b(f, 1) || !(e || f || d.type == CKEDITOR.NODE_ELEMENT && d.isBlockBoundary() &&
                d.getBogus()) ? !0 : !1
        } function g(a) { l(a, !1); var b = a.getDocument().createText(u); a.setCustomData("cke-fillingChar", b); return b } function l(a, b) {
        ...
        } function k(a, b) { return b ? a.replace(r, function (a, b) { return b ? " " : "" }) : a.replace(u, "") } function q(a) {
            ...
            function c() { var a = e.getSelection(); a && a.removeAllRanges() } var e = b.editor; e.on("contentDom", function () {
                function b() { I = new CKEDITOR.dom.selection(e.getSelection()); I.lock() } function c() {
                    ...
                    CKEDITOR.env.webkit ? "DOMFocusIn" : "focus", function () { v && CKEDITOR.env.webkit && (v = e._.previousActive && e._.previousActive.equals(f.getActive())); e.unlockSelection(v); v = 0 }, null, null, -1); g.attachListener(g, "mousedown", function () { v = 0 }); if (CKEDITOR.env.ie || q) p ? g.attachListener(g, "beforedeactivate", b, null, null, -1) : g.attachListener(e, "selectionCheck", b, null, null, -1), g.attachListener(g, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function () { e.lockSelection(I); v = 1 }, null, null, -1), g.attachListener(g, "mousedown", function () {
                        ...
                        var J; g.attachListener(g, "mousedown", function (a) { 2 == a.data.$.button && ((a = e.document.getSelection()) && a.getType() != CKEDITOR.SELECTION_NONE || (J = e.window.getScrollPosition())) }); g.attachListener(g, "mouseup", function (a) { 2 == a.data.$.button && J && (e.document.$.documentElement.scrollLeft = J.x, e.document.$.documentElement.scrollTop = J.y); J = null }); if ("BackCompat" != f.$.compatMode) {
                            if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) k.on("mousedown", function (a) {
                                function b(a) {
                                    ...
                                    var d = n.$.createTextRange(); try { d.moveToPoint(a.$.clientX, a.$.clientY) } catch (e) { } var f = d.duplicate(); k.on("mousemove", b); h.on("mouseup",
                                        c); k.on("mouseup", c)
                                }
                        ...
                        var F; g.attachListener(g, "mousedown", function () { F = 1 }); g.attachListener(f.getDocumentElement(),
                            "mouseup", function () { F && d.call(e); F = 0 })
        ...
        }; CKEDITOR.SELECTION_NONE = 1; CKEDITOR.SELECTION_TEXT = 2; CKEDITOR.SELECTION_ELEMENT = 3; var p = "function" != typeof window.getSelection, x = 1; CKEDITOR.dom.selection = function (a) {
            ...
            getNative: function () {
            ...
            }, getType: p ? function () { var a = this._.cache; if (a.type) return a.type; var b = CKEDITOR.SELECTION_NONE; try { var c = this.getNative(), d = c.type; "Text" == d && (b = CKEDITOR.SELECTION_TEXT); "Control" == d && (b = CKEDITOR.SELECTION_ELEMENT); c.createRange().parentElement() && (b = CKEDITOR.SELECTION_TEXT) } catch (e) { } return a.type = b } : function () {
                var a = this._.cache; if (a.type) return a.type; var b =
                    CKEDITOR.SELECTION_TEXT, c = this.getNative(); if (!c || !c.rangeCount) b = CKEDITOR.SELECTION_NONE; else if (1 == c.rangeCount) { var c = c.getRangeAt(0), d = c.startContainer; d == c.endContainer && 1 == d.nodeType && 1 == c.endOffset - c.startOffset && G[d.childNodes[c.startOffset].nodeName.toLowerCase()] && (b = CKEDITOR.SELECTION_ELEMENT) } return a.type = b
            }, getRanges: function () {
                var a = p ? function () {
                    function a(b) { return (new CKEDITOR.dom.node(b)).getIndex() } var b = function (b, c) {
                        b = b.duplicate(); b.collapse(c); var d = b.parentElement(); if (!d.hasChildNodes()) return {
                            container: d,
                            offset: 0
                        }; for (var e = d.children, f, h, g = b.duplicate(), l = 0, v = e.length - 1, k = -1, m, p; l <= v;)if (k = Math.floor((l + v) / 2), f = e[k], g.moveToElementText(f), m = g.compareEndPoints("StartToStart", b), 0 < m) v = k - 1; else if (0 > m) l = k + 1; else return { container: d, offset: a(f) }; if (-1 == k || k == e.length - 1 && 0 > m) {
                            ...
                            for (d = e.length; 0 < g && 0 < d;)h = e[--d], h.nodeType == CKEDITOR.NODE_TEXT && (p = h, g -= h.nodeValue.length); return { container: p, offset: -g }
                ...
                var b =
                    this.root.editor, b = b && b._.hiddenSelectionContainer; this.reset(); if (b) for (var b = this.root, c, d = 0; d < a.length; ++d)c = a[d], c.endContainer.equals(b) && (c.endOffset = Math.min(c.endOffset, b.getChildCount())); if (a.length) if (this.isLocked) { var f = CKEDITOR.document.getActive(); this.unlock(); this.selectRanges(a); this.lock(); f && !f.equals(this.root) && f.focus() } else {
                        var k; a: {
                            var q, w; if (1 == a.length && !(w = a[0]).collapsed && (k = w.getEnclosedNode()) && k.type == CKEDITOR.NODE_ELEMENT && (w = w.clone(), w.shrink(CKEDITOR.SHRINK_ELEMENT,
                                !0), (q = w.getEnclosedNode()) && q.type == CKEDITOR.NODE_ELEMENT && (k = q), "false" == k.getAttribute("contenteditable"))) break a; k = void 0
                        } if (k) this.fake(k); else {
                            if (p) {
                                w = CKEDITOR.dom.walker.whitespaces(!0); q = /\ufeff|\u00a0/; b = { table: 1, tbody: 1, tr: 1 }; 1 < a.length && (k = a[a.length - 1], a[0].setEnd(k.endContainer, k.endOffset)); k = a[0]; a = k.collapsed; var t, u, r; if ((c = k.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && c.getName() in G && (!c.is("a") || !c.getText())) try {
                                    r = c.$.createControlRange(); r.addElement(c.$); r.select();
                                    return
    ...
    (function () {
        function a(a, b) { for (var c, d; (a = a.getParent()) && !a.equals(b);)if (a.getAttribute("data-nostyle")) c = a; else if (!d) { var e = a.getAttribute("contentEditable"); "false" == e ? c = a : "true" == e && (d = 1) } return c } function d(a, b, c, d) { return (a.getPosition(b) | d) == d && (!c.childRule || c.childRule(a)) } function b(c) {
            var f = c.document; if (c.collapsed) f = G(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END); else {
                            ...
                            for (var k = G(this, f), u = k.hasAttributes(), x = r.getCommonAncestor(), y = {}, z = {}, B = {}, C = {}, U, O, da; k && x;) {
                                if (x.getName() == g) {
                                    for (U in h.attributes) !C[U] && (da = x.getAttribute(O)) &&
                                        (k.getAttribute(U) == da ? z[U] = 1 : C[U] = 1); for (O in h.styles) !B[O] && (da = x.getStyle(O)) && (k.getStyle(O) == da ? y[O] = 1 : B[O] = 1)
                                } x = x.getParent()
                            } for (U in z) k.removeAttribute(U); for (O in y) k.removeStyle(O); u && !k.hasAttributes() && (k = null); k ? (r.extractContents().appendTo(k), r.insertNode(k), D.call(this, k), k.mergeSiblings(), CKEDITOR.env.ie || k.$.normalize()) : (k = new CKEDITOR.dom.element("span"), r.extractContents().appendTo(k), r.insertNode(k), D.call(this, k), k.remove(!0)); r = null
                        }
            ...
            function b() { for (var a = new CKEDITOR.dom.elementPath(d.getParent()), c = new CKEDITOR.dom.elementPath(m.getParent()), e = null, f = null, g = 0; g < a.elements.length; g++) { var h = a.elements[g]; if (h == a.block || h == a.blockLimit) break; n.checkElementRemovable(h, !0) && (e = h) } for (g = 0; g < c.elements.length; g++) { h = c.elements[g]; if (h == c.block || h == c.blockLimit) break; n.checkElementRemovable(h, !0) && (f = h) } f && m.breakParent(f); e && d.breakParent(e) } a.enlarge(CKEDITOR.ENLARGE_INLINE, 1); var c =
                ...
                } else { var m = c.endNode, n = this; b(); for (e = d; !e.equals(m);)f = e.getNextSourceNode(), e.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(e) && (e.getName() == this.element ? t.call(this, e) : p(e, h(this)[e.getName()]), f.type == CKEDITOR.NODE_ELEMENT && f.contains(d) && (b(), f = d.getNext())), e = f } a.moveToBookmark(c); a.shrink(CKEDITOR.NODE_ELEMENT, !0)
        } function e(a) {
            var b = []; a.forEach(function (a) {
                if ("true" ==
                    a.getAttribute("contenteditable")) return b.push(a), !1
            }, CKEDITOR.NODE_ELEMENT, !0); return b
        } function g(a) { var b = a.getEnclosedNode() || a.getCommonAncestor(!1, !0); (a = (new CKEDITOR.dom.elementPath(b, a.root)).contains(this.element, 1)) && !a.isReadOnly() && u(a, this) } function l(a) {
        ...
        } function k(a) { var b = a.createBookmark(!0), c = a.createIterator(); c.enforceRealBlocks = !0; this._.enterMode && (c.enlargeBr = this._.enterMode != CKEDITOR.ENTER_BR); for (var d, e = a.document, f; d = c.getNextParagraph();)!d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (f = G(this, e, d), w(d, f)); a.moveToBookmark(b) } function q(a) {
            var b = a.createBookmark(1), c = a.createIterator(); c.enforceRealBlocks = !0; c.enlargeBr = this._.enterMode != CKEDITOR.ENTER_BR; for (var d, e; d = c.getNextParagraph();)this.checkElementRemovable(d) &&
                (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && d.copyAttributes(e), w(d, e)) : t.call(this, d)); a.moveToBookmark(b)
        } function w(a, b) {
            var c = !b; c && (b = a.getDocument().createElement("div"), a.copyAttributes(b)); var d = b && b.is("pre"), e = a.is("pre"), g = !d && e; if (d && !e) {
                ...
                var c = b, k; (k = c.getPrevious(R)) && k.type == CKEDITOR.NODE_ELEMENT && k.is("pre") && (d = y(k.getHtml(), /\n$/, "") + "\n\n" + y(c.getHtml(), /^\n/, ""), CKEDITOR.env.ie ? c.$.outerHTML = "\x3cpre\x3e" + d + "\x3c/pre\x3e" :
        ...
        } function D(a) { for (var b = h(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;)d = c.getItem(e), d.isReadOnly() || t.call(this, d, !0); for (var f in b) if (f != this.element) for (c = a.getElementsByTag(f), e = c.count() - 1; 0 <= e; e--)d = c.getItem(e), d.isReadOnly() || p(d, b[f]) } function p(a, b, c) {
        ...
        } function G(a, b, c) { var d; d = a.element; "*" == d && (d = "span"); d = new CKEDITOR.dom.element(d, b); c && c.copyAttributes(d); d = u(d, a); b.getCustomData("doc_processing_style") && d.hasAttribute("id") ? d.removeAttribute("id") : b.setCustomData("doc_processing_style", 1); return d } function u(a, b) { var c = b._.definition, d = c.attributes, c = CKEDITOR.style.getStyleText(c); if (d) for (var e in d) a.setAttribute(e, d[e]); c && a.setAttribute("style", c); return a } function r(a,
            b) { for (var c in a) a[c] = a[c].replace(C, function (a, c) { return b[c] }) } function h(a) { if (a._.overrides) return a._.overrides; var b = a._.overrides = {}, c = a._.definition.overrides; if (c) { CKEDITOR.tools.isArray(c) || (c = [c]); for (var d = 0; d < c.length; d++) { var e = c[d], f, g; "string" == typeof e ? f = e.toLowerCase() : (f = e.element ? e.element.toLowerCase() : a.element, g = e.attributes); e = b[f] || (b[f] = {}); if (g) { var e = e.attributes = e.attributes || [], h; for (h in g) e.push([h.toLowerCase(), g[h]]) } } } return b } function n(a, b, c) {
                var d = new CKEDITOR.dom.element("span");
                d[c ? "setStyle" : "setAttribute"](a, b); return d[c ? "getStyle" : "getAttribute"](a)
            } function m(a, b, c) { var d = a.document, e = a.getRanges(); b = b ? this.removeFromRange : this.applyToRange; for (var f, g = e.createIterator(); f = g.getNextRange();)b.call(this, f, c); a.selectRanges(e); d.removeCustomData("doc_processing_style") } var z = {
            ...
            }, B = { a: 1, blockquote: 1, embed: 1, hr: 1, img: 1, li: 1, object: 1, ol: 1, table: 1, td: 1, tr: 1, th: 1, ul: 1, dl: 1, dt: 1, dd: 1, form: 1, audio: 1, video: 1 }, E = /\s*(?:;\s*|$)/, C = /#\((.+?)\)/g, H = CKEDITOR.dom.walker.bookmark(0, 1), R = CKEDITOR.dom.walker.whitespaces(1); CKEDITOR.style = function (a, b) {
                ...
                }, removeFromRange: function (a) { this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? c : this.type == CKEDITOR.STYLE_BLOCK ? q : this.type == CKEDITOR.STYLE_OBJECT ? l : null; return this.removeFromRange(a) }, applyToObject: function (a) { u(a, this) }, checkActive: function (a, b) {
                    switch (this.type) {
    ...
    (function () {
        var a = {}, d = {}, b; for (b in CKEDITOR.dtd.$blockLimit) b in CKEDITOR.dtd.$list || (a[b] = 1); for (b in CKEDITOR.dtd.$block) b in CKEDITOR.dtd.$blockLimit || b in CKEDITOR.dtd.$empty || (d[b] = 1); CKEDITOR.dom.elementPath = function (b, e) {
            var g = null, l = null, k = [], q = b, w; e = e || b.getDocument().getBody(); do if (q.type == CKEDITOR.NODE_ELEMENT) {
                k.push(q); if (!this.lastElement && (this.lastElement = q, q.is(CKEDITOR.dtd.$object) || "false" == q.getAttribute("contenteditable"))) continue; if (q.equals(e)) break; if (!l && (w = q.getName(),
                    "true" == q.getAttribute("contenteditable") ? l = q : !g && d[w] && (g = q), a[w])) { if (w = !g && "div" == w) { a: { w = q.getChildren(); for (var f = 0, y = w.count(); f < y; f++) { var A = w.getItem(f); if (A.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[A.getName()]) { w = !0; break a } } w = !1 } w = !w } w ? g = q : l = q }
            } while (q = q.getParent()); l || (l = e); this.block = g; this.blockLimit = l; this.root = e; this.elements = k
        }
    })();
                ...
                var a = this, c = CKEDITOR.dom.walker.bookmark(), d = [], g; return {
                    getNextRange: function (l) {
                        g = void 0 === g ? 0 : g + 1; var k = a[g]; if (k && 1 < a.length) {
                            if (!g) for (var q = a.length - 1; 0 <= q; q--)d.unshift(a[q].createBookmark(!0)); if (l) for (var w = 0; a[g + w + 1];) {
                                var f = k.document; l = 0; q = f.getById(d[w].endNode); for (f = f.getById(d[w + 1].startNode); ;) {
                                    q =
                                    q.getNextSourceNode(!1); if (f.equals(q)) l = 1; else if (c(q) || q.type == CKEDITOR.NODE_ELEMENT && q.isBlockBoundary()) continue; break
                                } if (!l) break; w++
