...
@Component({
  selector: 'app-application-per-type',
  templateUrl: './application-per-type.component.html',
  styleUrls: ['./application-per-type.component.css']
})
export class ApplicationPerTypeComponent   extends BaseComponent implements OnInit {
  FormName: string = '';
  ...
  GetReport() {
    if (localStorage.getItem("language")=="ar")
    {
      ...
      this._svc.GetReport(this.objApplicationDetailReport,"Reports/ApplicationsPerType").subscribe(
      data => {
